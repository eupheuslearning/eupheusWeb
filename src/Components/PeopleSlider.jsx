...
const PeopleSlider = () => {
  ...
  return (
    <div
      ref={sliderRef}
      className="flex w-fit gap-8 people px-4 h-[500px] overflow-hidden"
    >
      ...
      <div className="flex flex-col items-center sm:w-[16vw] w-[30vw]">
        ...
        <span className=" text-gray-600 sm:text-sm text-xs">AVP TRAINING</span>
      </div>
      <div className="flex flex-col items-center sm:w-[16vw] w-[30vw]">
        <img
          src={p6}
      ...
      <div className="flex flex-col items-center sm:w-[16vw] w-[30vw]">
        ...
        <span className=" text-gray-600 sm:text-sm text-xs">VP SALES</span>
        <span className=" text-gray-600 sm:text-sm text-xs">(MAHARASHTRA)</span>
      </div>
      <div className="flex flex-col items-center sm:w-[16vw] w-[30vw]">
        <img
          src={p12}
