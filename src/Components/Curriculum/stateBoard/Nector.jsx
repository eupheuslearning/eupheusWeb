...
import book1 from "../../../assets/curriculum/stateBoard/nector/1.png";
import book2 from "../../../assets/curriculum/stateBoard/nector/2.png";
import englishvibes from "../../../assets/curriculum/stateBoard/nector/Curriculum Catalogue_2021-22_Page_69.jpg";
        ...
        <div className="flex sm:flex-row flex-col gap-1 w-full px-4 sm:px-0">
          ...
          <div className="flex gap-4 rounded-md w-fit px-3 justify-center bg-[#77ae5a] py-2">
            <table className="">
              ...
              <tr>
                <td className="text-center">Book 1 Term 1 </td>
                <td className="text-center">370</td>
              </tr>
              <tr>
                <td className="text-center">Book 1 Term 2 </td>
                <td className="text-center">370</td>
              </tr>
              <tr>
                <td className="text-center">Book 1 Term 3 </td>
                <td className="text-center">370</td>
              </tr>
              <tr>
                <td className="text-center">Book 2 Term 1 </td>
                <td className="text-center">380</td>
              </tr>
              <tr>
                <td className="text-center">Book 2 Term 2 </td>
                <td className="text-center">380</td>
              </tr>
              <tr>
                <td className="text-center">Book 2 Term 3 </td>
                <td className="text-center">380</td>
              </tr>
              <tr>
                <td className="text-center">Book 3 Term 1 </td>
                <td className="text-center">395</td>
              </tr>
              <tr>
                <td className="text-center">Book 3 Term 2 </td>
                <td className="text-center">395</td>
              </tr>
              <tr>
                <td className="text-center">Book 3 Term 3 </td>
                <td className="text-center">395</td>
              </tr>
              <tr>
                <td className="text-center">Book 4 Term 1 </td>
                <td className="text-center">410</td>
              </tr>
              <tr>
                <td className="text-center">Book 4 Term 2 </td>
                <td className="text-center">410</td>
              </tr>
              <tr>
                <td className="text-center">Book 4 Term 3 </td>
                <td className="text-center">410</td>
              </tr>
              <tr>
                <td className="text-center">Book 5 Term 1 </td>
                <td className="text-center">425</td>
              </tr>
              <tr>
                <td className="text-center">Book 5 Term 2 </td>
                <td className="text-center">425</td>
              </tr>
              <tr>
                <td className="text-center">Book 5 Term 3 </td>
                <td className="text-center">425</td>
              </tr>
            </table>
          </div>
