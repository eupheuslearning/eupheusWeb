      ...
      >
        ...
        <div className="flex sm:flex-row flex-col gap-1 w-full px-4 sm:px-0">
          <span className="sm:w-4/5 w-full">
            ...
            awareness about the environment. It sets ground to build on
            observation, sequential thinking, and socio-emotional attitudes. The
            series assists learners to discover their surroundings and develop
            their cognitive capacity. The approach and activities focus on
          ...
          <div className="flex flex-col sm:w-[30%] w-full">
            ...
            <ul className="px-2 py-1 w-full rounded-md bg-[#a25db7] text-white">
              <li>
                ...
                <b> Object Identification and Association </b>
                Develops ability to recognise, name and recall concepts, ideas
                and objects.
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Creative Appreciation</b>
                Builds ability to think creatively and express.
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Independent Thinking and Problem Solving </b>
                Interesting child-friendly activities that enhance higher order
                thinking skills (HOTS).
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Visual Memory</b>
                Tasks that develop the ability to distinguish between objects,
                pictures and physical characteristics.
              </li>
            </ul>
          </div>
        </div>
