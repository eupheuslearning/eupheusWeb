      ...
      >
        ...
        <div className="flex sm:flex-row flex-col gap-1 w-full px-4 sm:px-0">
          <span className="sm:w-4/5 w-full">
            ...
            It is designed by experienced teachers and adheres to the elements
            of Multiple Intelligences and Bloom's Taxonomy. Our activity-based
        ...
        <div className="flex sm:flex-row flex-col gap-1 w-full px-4 sm:px-0">
          <span className="sm:w-4/5 w-full">
            ...
            ensure language development in early years. The approach and
            activities focus on building the following skills:
          </span>
        </div>
          ...
          <div className="flex flex-col sm:w-[30%] w-full">
            ...
            <ul className="px-2 py-1 w-full rounded-md bg-orange-500 text-white">
              <li>
                ...
                <b> Revision Sheet </b>
                Recapitulation of concepts covered in the previous class.
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Word building,</b>
                phonetic practice of CVC words, and learning picture-word
                association.
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Word Wall</b>
                Helps to recall the vowels sound and usage.
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Reading</b>
                Helps in reading by blending the sounds.
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-white" /> &nbsp;{" "}
                <b>Grammar Pages</b>
                Teaches useful topics of grammar through child-friendly
                activities.
              </li>
            </ul>
          </div>
