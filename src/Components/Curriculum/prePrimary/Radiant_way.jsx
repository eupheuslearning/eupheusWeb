      ...
      >
        ...
        <div className="flex sm:flex-row flex-col gap-1 w-full px-4 sm:px-0">
          <span className="sm:w-4/5 w-full">
            <span className="text-[#76ad59] font-semibold">
              The Radiant Way Pre-Primer and Primer series{" "}
            </span>
            has been specially prepared to meet the needs of the students who
            have been newly introduced to the study of English in the
            pre-primary classes of English-medium schools. While the series is
            linked with the Radiant Way series and the New Radiant Readers, it
        ...
        <div className="flex sm:flex-row flex-col gap-2 px-4 sm:px-0 items-center w-full">
          ...
          <div className="flex flex-col sm:w-[60%] w-full">
            ...
            <ul className="px-2 py-1 w-full rounded-md bg-[#e1ec7a] text-black">
              ...
              <li>
                <Circle className="!text-[0.5rem] text-black" /> &nbsp; Most of
                the vocabulary words provided in the series have short vowel
                sounds
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                Attractive four-colour illustrations found on most of the pages
                of the series
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-black" /> &nbsp;
              ...
              <li>
                <Circle className="!text-[0.5rem] text-black" /> &nbsp; Variety
                of exercises provided for revision work
              </li>
              <li>
                <Circle className="!text-[0.5rem] text-black" /> &nbsp;
