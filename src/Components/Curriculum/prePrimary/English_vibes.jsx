...
import book1 from "../../../assets/curriculum/english_vibes/1.png";
import book2 from "../../../assets/curriculum/english_vibes/2.png";
import englishvibes from "../../../assets/curriculum/english_vibes/Curriculum Catalogue_2021-22_Page_21.jpg";
        ...
        >
          ...
          <div className="flex sm:flex-row flex-col gap-1 w-full px-4 sm:px-0">
            <span className="sm:w-4/5 w-full">
              ...
              <b>learning of phonics</b> is emphasized in each learning unit
              from levels 1 through 5.
            </span>
          ...
          <div className="flex sm:flex-row flex-col gap-2 px-4 sm:px-0 items-center w-full">
            <div className="flex flex-col sm:w-[70%] w-full">
              ...
              <ul className="px-2 py-1 w-full rounded-md bg-[#ffb2ec] text-black">
                <li>
                  ...
                  Learning language through literary tools—eclectic literary
                  selection that includes classic and contemporary, Indian as
                  well as western writings of renowned authors
                </li>
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp; Varied
                  reading comprehension tasks complying with examination
                  patterns and beyond
                </li>
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                ...
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                  Speaking skills imparted through varied tasks including pair
                  work, speeches, and debates
                </li>
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                  Writing tasks exhaustively scaffolded through tips, graphic
                  organizers
                </li>
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                ...
                <li>
                  ...
                  topics focussed on acquiring both meaning as well as the form
                  of language structures through learner-friendly tasks
                </li>
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
            ...
            <div className="flex flex-col sm:w-3/12 w-full">
              ...
              <ul className="px-2 py-1 w-full rounded-md bg-[#ffb2ec] text-black">
                ...
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                  Enhances the alreadyacquired reading, writing, grammar, and
                  vocabulary skills
                </li>
                <li>
                  <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                  Iterates the rules of grammar, vocabulary, and guidelines for
          ...
          <div className="flex sm:flex-row flex-col px-4 sm:px-0 gap-4 items-center w-full">
            <div className="flex flex-col items-center sm:w-1/2 w-full">
              ...
              <div className="m-3 flex flex-col w-full">
                ...
                <ul className="px-2 py-1 w-full rounded-md bg-[#ffb2ec] text-black">
                  ...
                  <li>
                    <Circle className="!text-[0.5rem] text-black" /> &nbsp;
                    Enable parents and teachers to gather performance analytics
                    providing critical, performance-enhancing feedback to the
                    learner
                  </li>
                </ul>
              </div>
            ...
            <div className="flex flex-row items-center sm:w-1/2 w-full">
             <div className="flex flex-row w-[50%]">  <img src={book1} className="w-[80%] h-auto" alt="" /></div>
             <div className="flex flex-row w-[70%]">  <img src={book2} className="w-[80%] h-auto" alt="" /></div>
            </div>
          </div>
        </div>
      </>
